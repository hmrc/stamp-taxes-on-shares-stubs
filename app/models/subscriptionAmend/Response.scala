...
object Response {
  ...
  case class STSSubscriptionAmendAPIResponse(
    responseCommon: ResponseCommon,
    responseDetail: Option[ResponseDetail]
  )

  object STSSubscriptionAmendAPIResponse {
    implicit val format: OFormat[STSSubscriptionAmendAPIResponse] = Json.format[STSSubscriptionAmendAPIResponse]
  }
